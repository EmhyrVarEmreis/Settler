...
angular.module('settlerServices').factory('Auth', function Auth(Principal, AuthenticateCli, localStorageService, $rootScope, $state, $q/*, Account, Register, Activate, Password*/) {
    return {
