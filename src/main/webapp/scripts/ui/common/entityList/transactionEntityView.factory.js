(function () {
    ...
    angular.module('settlerApplication').factory('transactionEntityViewFactory', function (transactionViewFactory) {
        var object = {};
        ...
        object.columns = [
            ...
            },
            {
                ...
                type:        'default',
                isEmpty:     "N/D",
                preTransformData:   function (data) {
                    return data.split(/,\s/);
                },
                transform:   function (data, entry) {
                    return data.toString().replace(/\s\(.+\)\s/, ' (') + ')';
                },
                index:       object.columnsCount++
            },
            {
            ...
            },
            {
                ...
                isEmpty:     "N/D",
                transform:   function (data, entry) {
                    return parseFloat(data.toString().replace(/,/, '.')).toFixed(2).toString().replace(/\./, ',');
                },
                index:       object.columnsCount++
            },
            {
        ...
        object.listFactory = transactionViewFactory;
